...
function generarToken(){
    return md5(uniqid(mt_rand(), false)); //creamos un identificador para una solicitud pero que sea aleatoria sin importar las circunstancias
}
...
function verificaTokenRequest($user_id, $token, $con){ //verifica si los datos existen en la base de datos
